                    ...
                    <div class="header-content">
                        <div class="hidden-xs">
                            <div class="header-content-inner text-left col-md-offset-2 col-lg-offset-4">
                                <h1 class="title">Sci</h1><text class="title">entific</text> <h1 class="title">A</h1><text class="title">pplication</text> <h1 class="title">P</h1><text class="title">rogramming</text> <h1 class="title">I</h1><text class="title">nterface</text>
                            </div>
                        </div>
